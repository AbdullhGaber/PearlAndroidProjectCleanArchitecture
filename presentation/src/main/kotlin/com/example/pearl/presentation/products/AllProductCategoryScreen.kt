...
fun AllProductCategoryScreen(
    ...
    Box(
        ...
        Column(Modifier.padding(ExtraSmallPadding2).fillMaxSize()) {
            Row(
            ...
            LazyVerticalStaggeredGrid(
                ...
                modifier = Modifier.padding(horizontal = MediumPadding1).weight(1f),
                state = state,
                horizontalArrangement = Arrangement.spacedBy(10.dp),
                content = {
                    val products = productsState.products.filter { it.productType == productType.name}
                    items(products.size) {
                       FeaturedProductCard(

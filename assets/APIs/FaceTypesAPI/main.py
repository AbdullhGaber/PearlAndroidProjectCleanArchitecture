...
model = tf.keras.models.load_model(r"C:\Users\hp\AndroidStudioProjects\Projects\JPCProjects\Pearl\assets\AI models\3SkinTypesPearlGP_MobileNetmodel.keras")
...
@app.route('/faceType')
def index():
    return 'Welcome to the Skin Type Classification API!'

# Define a route for prediction
@app.route('/faceType/predict', methods=['POST'])
def predict():
    try:

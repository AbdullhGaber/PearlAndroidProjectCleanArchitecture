    ...
    Box(
        ...
        .background(Color.White)
            ...
            Image(
                ...
                modifier = Modifier.align(Alignment.TopEnd).padding(20.dp).clickable { navigateToScreen(Route.HomeScreen.route) }
            )
        ...
        Column(
            ...
            PrimaryButton(
                ...
                onClick = { navigateToScreen(Route.MyAppointmentScreen.route) },

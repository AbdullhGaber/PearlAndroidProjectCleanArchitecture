package com.example.pearl.navigation
...
import com.example.pearl.design_system.components.HorizontalLine
...
import com.example.pearl.presentation.common.doctors
...
import com.example.pearl.presentation.nav_graph.getBottomNavigationScreenRouteByIndex
import com.example.pearl.presentation.settings.SettingsViewModel
import com.example.pearl.presentation.common.getProductTypeFromString
import com.example.pearl.presentation.nav_graph.getDrawerNavigationScreenRouteByIndex
import com.example.pearl.presentation.pearl_navigator.*
                ...
                sideMenuItems.forEachIndexed{
                    ...
                    NavigationDrawerItem(
                        ...
                        icon = {
                            ...
                            val selIcon = sideMenuItem.selectedIcon
                            if(selected && selIcon != null){
                                Image(
                                    painter = painterResource(id = selIcon ),
                                    contentDescription = null
                                )
                            }
